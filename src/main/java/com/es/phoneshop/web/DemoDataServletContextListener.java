...
public class DemoDataServletContextListener implements ServletContextListener {
    ...
    private synchronized void saveSampleProducts() {
        ...
        productDao.save(new Product("simsxg75", "Siemens SXG75", new BigDecimal(150), usd, 1, "https://raw.githubusercontent.com/andrewosipenko/phoneshop-ext-images/master/manufacturer/Siemens/Siemens%20SXG75.jpg", historiesAnother));
    }
}